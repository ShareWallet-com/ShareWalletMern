...
function Header2() {
  return (
    <div className='relative flex items-center flex-col justify-center bg-gradient-to-br from-gray-100 via-[#f0f0ff] to-[#e5e6ff] 
                animate-[gradientMove_8s_ease-in-out_infinite] bg-[length:200%_200%] h-[90vh] gap-4 overflow-hidden'>
        ...
        <div className='flex flex-col items-center justify-center gap-4'>
            ...
            <p className='text-sm'>Save together, borrow interest-free, and grow your shared wealth—all in one wallet.</p>
        </div>
        <div className="flex flex-col items-center justify-center w-full gap-4 px-4 sm:flex-col">
